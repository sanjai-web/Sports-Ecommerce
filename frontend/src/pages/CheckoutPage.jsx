    ...
    return (
      <div style={{ background: 'var(--bg)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div className="fitgear-card p-5 text-center" style={{ maxWidth: 500, width: '100%' }}>
          ...
          <button className="btn btn-primary px-5 py-2" onClick={() => navigate('/orders')}>
            View Orders
          </button>
        </div>
      </div>
          ...
          <div className="row g-4">
                ...
                {[
                  ...
                  <label 
                    ...
                    style={{ 
                      ...
                      gap: '0.75rem', 
                      padding: '1rem', 
                      border: `1.5px solid ${form.paymentMode === value ? 'var(--primary)' : 'var(--border)'}`, 
                      borderRadius: 'var(--radius-sm)', 
                      marginBottom: '0.75rem', 
                      background: form.paymentMode === value ? 'rgba(10,65,116,0.04)' : 'transparent', 
            ...
            <div className="col-lg-5">
              <div className="fitgear-card p-4 sticky-top" style={{ top: 80 }}>
                    ...
                    return (
                      <div key={product._id} className="d-flex justify-content-between align-items-center mb-3">
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                          <div style={{ width: 44, height: 44, background: 'var(--pale-blue)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <img 
                              ...
                              onError={(e) => {
                                e.target.src = 'https://via.placeholder.com/36x36?text=Product';
                              }}
                            />
                          </div>
                          <div>
                            <div style={{ fontSize: '0.82rem', fontWeight: 600, color: 'var(--navy)', lineHeight: 1.2 }}>
                              {product.name}
                            </div>
                        ...
                        <span style={{ fontWeight: 700, color: 'var(--dark-blue)', fontSize: '0.9rem' }}>
                          ₹{(discountedPrice * item.quantity).toLocaleString(undefined, { minimumFractionDigits: 2 })}
                        </span>
                      </div>
                    );
                  })}
                ...
                <button type="submit" className="btn btn-primary w-100 py-3" style={{ fontSize: '1rem', fontWeight: 600 }}>
                  Place Order
                </button>
              </div>
            </div>
